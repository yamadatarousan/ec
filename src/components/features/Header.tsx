        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <div className="bg-orange-400 text-gray-900 px-3 py-1 rounded font-bold text-xl">
                EC
              </div>
          ...
          <div className="hidden md:flex flex-1 max-w-2xl mx-8">
            <form onSubmit={handleSearch} className="w-full flex">
              ...
              <Button
                type="submit"
                variant="secondary"
                className="rounded-l-none bg-orange-400 hover:bg-orange-500 text-gray-900 px-4"
              >
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="/favorites"
              className="hidden sm:flex items-center space-x-1 hover:text-orange-400 transition-colors"
            >
        ...
        <div className="container-custom">
          ...
          >
            <Link
              ...
              className="block px-3 py-2 text-sm hover:text-orange-400 transition-colors"
            >
              家電・PC
            </Link>
            <Link
            ...
            <Link
              href="/deals"
              className="block px-3 py-2 text-sm hover:text-orange-400 transition-colors font-medium"
            >
              タイムセール
            </Link>
          </div>
